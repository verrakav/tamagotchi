//select pet screen
export const petScreen = document.getElementById("pet-screen");
//select good-dog
...
export let indEnergy = document.getElementById("energy-indicator");
export let indSkill = document.getElementById("skills-indicator");
export let indAge = document.getElementById("age-indicator");

//pet image & pet name
export const petName = document.getElementById("pet-name");
export const petImage = document.getElementById("pet-image");

//select mess
export const oopsTop = document.getElementById("oops-top");
